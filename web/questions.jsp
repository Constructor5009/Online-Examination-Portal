...
<!-- SIDEBAR -->
        ...
        <div class="panel form-style-6" style="max-width: 630px;float: right">   
        ...
        <option value="<%=list.get(i)%>"><%=list.get(i)%></option>
            ...
            %>
                       ...
                       <tr>
                           ...
                           <td colspan="2"><input type="text" name="opt1" class="text" placeholder="First Option" style="width: 130px;" ></td>
                       ...
                       <tr>
                           ...
                           <td colspan="2"><center><input type="text" name="correct" class="text" placeholder="Correct Answer" style="width:130px;" ></center></td>
                       <tr>

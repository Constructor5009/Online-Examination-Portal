...
<!-- SIDEBAR -->
			...
			<div class="content-area">
                            ...
                            <div class="panel" style="max-width: 430px;float:right">
                                <div class="title">
                                   All Courses
                                </div>
                                <table id="one-column-emphasis" style="min-width: 400px;margin: 5px; margin-top: 15px" >
    <colgroup>
    	<col class="oce-first" />
    </colgroup>
    <thead>
        ...
        <div  class="panel form-style-6" style="max-width: 350px; float:left">
           <div class="title">
                                   Add New Course
                                </div>
            <center>
               <form action="controller.jsp" >
                   ...
                   <table >
                       <tr>
                           ...
                           <td> <input type="text" name="coursename" class="text" placeholder="Course Name"  style="width: 150px;"></td>
                       </tr>
                       <tr>
                           <td><label>Total Marks</label></td>
                           <td><input type="text" name="totalmarks" class="text" placeholder="Total Marks" style="width: 150px;" ></td>
                       </tr>
                       <tr>
                           <td><label>Exam Time(in mins.)</label></td>
                           <td>
                                <input type="text" name="time" class="text" placeholder="MM" style="width: 150px;" >
                           </td>
